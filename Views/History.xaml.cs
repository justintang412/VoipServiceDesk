...
namespace Arco.Views
{
    ...
    public partial class History : UserControl
    {
        ...
        private async Task LoadData()
        {
            ...
            if (Inbound)
            {
                filter = builder.And(filter, builder.Or(builder.Eq("callto", _viewModel.User.UserConfig.Extno1), builder.Eq("callto", _viewModel.User.UserConfig.Extno2)));
            }
            ...
            _viewModel.NotifyChange("History");
        }
